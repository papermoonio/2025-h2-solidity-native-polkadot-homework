...
module.exports = {
  ...
  networks: {
    // This is the only network you need for `npx hardhat test`
    hardhat: {
      // Use Hardhat's default in-memory network with its 20 test accounts
      // No private keys, no Polkadot node, no nothing
      chainId: 31337,                    // optional, default anyway
      mining: {
        auto: true,                      // auto-mine by default (faster tests)
        interval: 0,
      },
    },
