...
describe('UniswapV2ERC20', function () {
  ...
  it('判断参数name, symbol, decimals, totalSupply, balanceOf, DOMAIN_SEPARATOR, PERMIT_TYPEHASH', async () => {
